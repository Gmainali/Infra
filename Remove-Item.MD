...
## Directory Structure
```Get-ChildItem -Path "C:\Users\" -Recurse -Directory | Select-Object FullName | Export-Csv -Path "c:\users\admin\desktop\exportfoldersroot.csv" -NoTypeInformation -Append
```
